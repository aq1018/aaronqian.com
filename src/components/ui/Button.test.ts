...
describe('Button Component', () => {
  ...
  describe('buttonVariants - TypeScript Types', () => {
    ...
    // eslint-disable-next-line vitest/expect-expect -- Type checking test validates TypeScript type safety
    it('should accept all valid color combinations', () => {
      buttonVariants({ color: 'primary' })
      buttonVariants({ color: 'accent' })
    ...
    // eslint-disable-next-line vitest/expect-expect -- Type checking test validates TypeScript type safety
    it('should accept boolean fullWidth', () => {
    ...
    it('should accept custom class string', () => {
      buttonVariants({ class: 'custom-class' })
    })
