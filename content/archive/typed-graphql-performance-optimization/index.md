...
date: 2021-10-01
aliases:
  - /blog/typed-graphql-performance-optimization/
tags:
  - graphql
  - typescript
  - optimization
...
Using the example above, Data Loaders will collect the individual user IDs in the resolver and fetch the collected user IDs in one SQL query after [nextTick](https://nodejs.org/learn/asynchronous-work/event-loop-timers-and-nexttick). It will then return the appropriate User object based on the supplied user ID.
