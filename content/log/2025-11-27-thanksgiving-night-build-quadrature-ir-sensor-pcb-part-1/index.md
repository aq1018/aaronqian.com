...
{{< model src="encoder-board.glb" alt="3D model of the dual ITR1204 IR sensor PCB" aspect="16/9" >}}
...
All four modes below use the same [datasheet numbers for ITR1204SR10A_TR(BY)](https://media.digikey.com/pdf/Data%20Sheets/Everlight%20PDFs/ITR1204SR10A_TR_Rev1_5-15-13.pdf):
